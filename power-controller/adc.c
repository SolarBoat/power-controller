...
#define CONVERSION_FACTOR_MOTOR_1_I (68.0 / 33.0 + 1.0) * 5.0 * ADC_REF_VOLTAGE * 256 / 4096 / ADC_SAMPLE_AVG
#define CONVERSION_FACTOR_MOTOR_2_I (68.0 / 33.0 + 1.0) * 5.0 * ADC_REF_VOLTAGE * 256 / 4096 / ADC_SAMPLE_AVG
